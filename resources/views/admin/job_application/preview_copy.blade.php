@extends('admin.job_application.parts.client_root')

@section('title','求人変更')

@section('css')
    <link rel="stylesheet" href="{{asset('client/css/company-edit/detail-preview/common.css')}}">
    <link rel="stylesheet" href="{{asset('client/css/company-edit/detail-preview/index.css')}}">
    <link rel="stylesheet" href="{{asset('client/css/company-edit/detail-preview/index_custom.css')}}">
    <link rel="stylesheet" href="{{asset('client/js/slick/slick_custom.css')}}">
    <link rel="stylesheet" href="{{asset('client/js/slick/slick-theme.css')}}">
@stop

@section('js')
    <script src="{{ asset('client/js/company/preview.js') }}"></script>
...
@section('content')
    <div class="main__content">
        ...
        <div class="main__img">
            ...
            @else
                <div class="video">
                    <video controls="" muted="" autoplay="" loop="" poster="" id="js_video_auto">
            ...
            <div class="js_short_length_videos video">
                @foreach($data->get("shortLengthVideos") as $key => $shortLengthVideo)
                    <video controls="controls" muted="" poster="" id="js_video_{{$key}}" style="display: none;">
                ...
                @foreach($data->get("companyIntroductionListsList") as $key => $companyIntroduction)
                    <section>
                        <div class="content">
                            ...
                            @else
                                <div class="video">
                                    <video controls="" muted="" autoplay="" loop="" poster="">
