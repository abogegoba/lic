...
@section('content')
    <h1 class="content-title" id="upload-content" data-upload-url="{{route('admin.upload')}}">会員登録</h1>

    <div style="margin-bottom: 2em;">
        <a href="{{route('admin.member.reload')}}">< 会員一覧に戻る</a>
    </div>

    {{Form::open(['url'=>route('admin.member.create')])}}

    @include('admin.member.parts.input')
