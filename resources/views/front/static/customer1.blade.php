...
@section('css')
    ...
    <style>
        .customer_info {
            background: url("{{asset('img/describe/vo_mk22.png')}}") no-repeat;
        ...
        <div class="inner">
            ...
            <div class="customer_info">
                <div class="all">
                    ...
                    <a class="molink pco" href="{{asset('video/describe/customer1.mp4')}}" data-lity>M・Kさんの自己PR動画を見る ▶</a>
                </div>
            </div>

            <div class="customer_info_mobile">
                <img src="{{asset('img/describe/vo_mk2.png')}}" alt="">
                <div class="all">
            ...
            <a class="molink spo" href="{{asset('video/describe/customer1.mp4')}}" data-lity>M・Kさんの自己PR動画を見る ▶</a>
            <a href="{{route('front.static.customer')}}" class="btn">▶ 利用者の声一覧</a>
            {{--<h2 class="name">産業能率大学 M・Kさんさん</h2>
            <div class="row">
                <div class="photo"><img src="{{asset('img/describe/vo_ms2.jpg')}}" alt="大東文化大学2年 Y・Kさん" class="auto"></div>
                <a  class="molink spo" href="{{asset('video/describe/customer2.mp4')}}" data-lity>M・Kさんの自己PR動画を見る ▶</a>
                <div class="mes">
