...
@section('css')
    ...
    <style>
        .customer_info {
            background: url("{{asset('img/describe/vo_yk22.png')}}") no-repeat;
        ...
        <div class="inner">
            ...
            <div class="customer_info">
                <div class="all">
                    ...
                    <!-- <a class="molink pco" href="{{asset('video/describe/customer2.mp4')}}" data-lity>Y・Kさんの自己PR動画を見る ▶</a> -->
                </div>
            </div>

            <div class="customer_info_mobile">
                <img src="{{asset('img/describe/vo_yk2.png')}}" alt="">
                <div class="all">
                    <p class="name">大東文化大学 Y・Kさん</p>
                    <h3>早くからキャリアを考える きっかけになりました。</h3>
                    <p>
                        就活は3年生になってからでいい”そんな風に思いながら毎日を過ごしていましたが、
                        LinkTを使ってみて将来のキャリアについて意識するようになりました。
            ...
            <!-- <a class="molink spo" href="{{asset('video/describe/customer2.mp4')}}" data-lity>M・Sさんの自己PR動画を見る ▶</a> -->
            <a href="{{route('front.static.customer')}}" class="btn">▶ 利用者の声一覧</a>
            {{--<h2 class="name">大東文化大学 Y・Kさん</h2>
            <div class="row">
