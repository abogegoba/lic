...
@section('css')
    ...
    <style>
        .customer_info {
            background: url("{{asset('img/describe/vo_kh22.png')}}") no-repeat;
        ...
        <div class="inner">
            ...
            <div class="customer_info">
                <div class="all">
                    ...
                    <a class="molink pco" href="{{asset('video/describe/customer4.mp4')}}" data-lity>K・Hさんの自己PR動画を見る ▶</a>
                </div>
            </div>
            ...
            <a class="molink spo" href="{{asset('video/describe/customer4.mp4')}}" data-lity>K・Hさんの自己PR動画を見る ▶</a>
            <a href="{{route('front.static.customer')}}" class="btn">▶ 利用者の声一覧</a>
            {{--<h2 class="name">亜細亜大学 K・Hさん</h2>
            <div class="row">
                <div class="photo"><img src="{{asset('img/describe/vo_ms2.jpg')}}" alt="亜細亜大学 K・Hさん" class="auto"></div>
                <a  class="molink spo" href="{{asset('video/describe/customer2.mp4')}}" data-lity>K・Hさんの自己PR動画を見る ▶</a>
                <div class="mes">
