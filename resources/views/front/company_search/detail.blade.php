...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('css/company-search/detail/index_new.css')}}">
                    ...
                    @else
                        <div class="video_tags">
                            @if(($data->get("shortLengthVideos.five")) !== null)
                                <p class="htmlvid">
                                    <a vidSrc="{{$data->get("shortLengthVideos.five")}}" class="tag cursor-pointer">
                                        <img src="{{asset('/img/common/play-circle-regular.png')}}" alt="">
                                        <img src="{{asset('/img/common/5sec.png')}}" alt="">
                                        <span>{{$data->get("shortLength5sVideoTitle")}}</span>
                                    </a>
                                </p>
                            @endif
                            ...
                            @if(($data->get("shortLengthVideos.ten")) !== null)
                                <p class="htmlvid">
                                    <a vidSrc="{{$data->get("shortLengthVideos.ten")}}" class="tag cursor-pointer">
                                        <img src="{{asset('/img/common/play-circle-regular.png')}}" alt="">
                                        <img src="{{asset('/img/common/10sec.png')}}" alt="">
                                        <span>{{$data->get("shortLength10sVideoTitle")}}</span>
                                    </a>
                                </p>
                            @endif
                            ...
                            @if(($data->get("shortLengthVideos.fifteen")) !== null)
                                <p class="htmlvid">
                                    <a vidSrc="{{$data->get("shortLengthVideos.fifteen")}}" class="tag cursor-pointer">
                                        <img src="{{asset('/img/common/play-circle-regular.png')}}" alt="">
                                        <img src="{{asset('/img/common/15sec.png')}}" alt="">
                                        <span>{{$data->get("shortLength15sVideoTitle")}}</span>
                                    </a>
                                </p>
                            @endif
                        </div>
                        ...
                        <div class="all_width">
                                    ...
                                    @foreach($data->get('jobApplications') as $key => $jobApplication)
                                        <li class="{{$key === 0 ? 'active':''}}">
                                            <a href="#{{$jobApplication->get('id')}}">
                                                {{mb_strlen($jobApplication->get('title')) > 5 ? mb_substr($jobApplication->get('title'), 0, 5).'...' : $jobApplication->get('title')}}
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            @foreach($data->get('jobApplications') as $key => $jobApplication)
                                <div id="{{$jobApplication->get('id')}}" class="job_application_with_switch_tab">
                                    <h2>{{$jobApplication->get('title')}}</h2>
