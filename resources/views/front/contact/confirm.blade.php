...
@section('content')
    <section class="main__content">
        ...
        {{Form::open(['url'=>route('front.contact.execute')])}}
            <table class="form__table">
                ...
                <tr>
                    <th>学校名</th>
                    <td>{{$data->get('schoolName')}}</td>
                </tr>
                <tr>
                    <th>学部・学科名</th>
                    <td>{{$data->get('faculty')}}</td>
                </tr>
                <tr>
                    <th>電話番号</th>
                    <td>{{$data->get('tel')}}</td>
            ...
            <div class="form__controls">
                <input type="button" value="修正する" class="prev js-btn-link" data-href="{{route("front.contact.revise")}}">
