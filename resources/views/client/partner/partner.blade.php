...
@section('title','パートナー企業様 ご紹介　｜　次世代型就活サイト　LinkT')

@section('css')
    <link rel="stylesheet" href="{{asset('css/partner/index.css')}}">
@stop
    ...
    <div class="main__content content__partner content__term">
        ...
        <div class="partner__content">
            <p class="partner__logo">
                <img src="{{asset('img/partner/logo/mbg-trade-media-japan01.png')}}" alt="株式会社トレードメディアジャパン">
            </p>
            ...
            <p>
                <a href="{{route('client.news.detail_3')}}">infitと株式会社トレードメディアジャパンのパートナー契約締結のリリースはこちら</a>
            </p>
        </div>

        <div class="partner__content">
            <p class="partner__logo">
                <img src="{{asset('img/partner/logo/nbc-nagasaki01.png')}}" alt="長崎放送株式会社">
            </p>
            <div class="partner__list">
                <dl>
                    <dt>会社名</dt>
            ...
            <p>
                <a href="{{route('client.news.detail_2')}}">infitと長崎放送のパートナー契約締結のリリースはこちら</a>
            </p>
        </div>

        <div class="partner__content">
            <p class="partner__logo">
                <img src="{{asset('img/partner/logo/dentsu01.png')}}" alt="株式会社 電通">
            </p>
            <div class="partner__list">
                <dl>
                    <dt>会社名</dt>
            ...
            <p>
                <a href="{{route('client.news.detail_1')}}">infitと電通のパートナー契約締結のリリースはこちら</a>
            </p>
        </div>

        <div class="partner__content">
            <p class="partner__logo">
                <img src="{{asset('img/partner/logo/gogaku01.png')}}" alt="Gogaku株式会社">
            </p>
            <div class="partner__list">
                <dl>
                    <dt>会社名</dt>
