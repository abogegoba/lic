...
@section('title','Web面接予約カレンダー│マイページ｜LinkT(リンクト)')
...
@section('content')
    ...
    <div class="main__content video-container">
        ...
        <form action="{{route('client.message.list')}}">
                                        ...
                                        <template v-if="day.thisMonth === currentMonth">
                                            <div class="plan-modal" :class="{'active' : (selectedUserId === appointment.id && isOpen) }">
                                                ...
                                                <div class="plan-modal__contents">
                                                    <p :data-href="appointment.studentDetailUrl" class="plan-modal__name js-link-area cursor-pointer"><img class="ico" src="{{asset('img/mypage/video/user-regular.svg')}}">@{{appointment.memberName}}</p>
                                                    <ul class="plan-modal__list">
                                                        <li><img class="ico" src="{{asset('img/mypage/video/university-solid.svg')}}">@{{appointment.schoolName}} @{{appointment.departmentName}}</li>
