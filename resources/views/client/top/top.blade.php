...
@section('description','次世代型新卒・第二新卒採用サービス【LinkT（リンクト）】は、企業の採用活動におけるコストや労力、情報格差を改善することができる新しい人材採用サービスです。LinkTによって採用活動の質を上げ、優秀な人材を確保することができます。')

@section('title','LinkT(リンクト) -企業向けTOP-│次世代型新卒・第二新卒採用サービス')

@section('css')
    <link rel="stylesheet" href="{{asset('css/client/index.css')}}">
    <link rel="stylesheet" href="{{asset('css/client/index_custom.css')}}">
    <link rel="stylesheet" href="{{asset('js/slick/slick.css')}}">
    <link rel="stylesheet" href="{{asset('js/slick/slick_custome.css')}}">
...
@section('content')
    <section class="main__catch requid">
        ...
        <nav class="navSp main__catch__nav">
            <a href="{{route('client.contact')}}">企業会員登録</a>
            <a href="{{route('client.static.use')}}">使い方はこちら</a>
        </nav>
        <picture>
            <source media="(max-width: 767px)" srcset="{{asset('img/client/index/photo_main-sp.jpg')}}">
            <img src="{{asset('img/client/index/photo_main-pc.jpg')}}" alt="就活の新時代へ">
        </picture>
    </section>
            ...
            <div id="media_slider" class="main__media_elements">
                <div class="slick-slide media_element media_image_bg_blc">
                    <div class="media__item__img img--logo">
                        <img src="{{asset('img/client/media/1_2x.png')}}" alt="">
                    </div>
                ...
                <div class="slick-slide media_element media_image_bg_wh">
                    <div class="media__item__img img--logo">
                        <img src="{{asset('img/client/media/2_2x.png')}}" alt="">
                    </div>
                    <div class="media_text">
                ...
                <div class="slick-slide media_element media_image_bg_wh">
                    <div class="media__item__img img--logo">
                        <img src="{{asset('img/client/media/3.jpg')}}" alt="">
                    </div>
                    <div class="media_text">
                ...
                <div class="slick-slide media_element media_image_bg_wh">
                    <div class="media__item__img img--logo">
                        <img src="{{asset('img/client/media/4_2x.png')}}" alt="">
                    </div>
                    <div class="media_text">
                ...
                <div class="slick-slide media_element media_image_bg_wh">
                    <div class="media__item__img img--logo">
                        <img src="{{asset('img/client/media/5_2x.png')}}" alt="">
                    </div>
                    <div class="media_text">
            ...
            <table>
                <tr>
                    <td>2020/03/03（火）
                        ...
                        <a class="mobile_view" href="{{route('client.news.detail_4')}}" rel="noopener">LinkT(リンクト)、新型コロナウイルス感染拡大による新卒採用イベント中止に伴い採用動画無料制作キャンペーン実施</a>
                    </td>
                    <td class="web_view"><span class="label label-blue">ニュースリリース</span></td>
                    <td class="web_view"><a href="{{route('client.news.detail_4')}}" rel="noopener">LinkT(リンクト)、新型コロナウイルス感染拡大による新卒採用イベント中止に伴い採用動画無料制作キャンペーン実施</a></td>
                </tr>
                <tr>
                    <td>2020/03/03（火）
                        <span class="mobile_view label label-blue">ニュースリリース</span><br>
                        <a class="mobile_view" href="{{route('client.news.detail_5')}}">LinkT(リンクト)、ローカル放送局の長崎放送株式会社と連携し新卒採用のリモート化を推奨</a>
                    </td>
                    <td class="web_view"><span class="label label-blue">ニュースリリース</span></td>
                    <td class="web_view"><a href="{{route('client.news.detail_5')}}">LinkT(リンクト)、ローカル放送局の長崎放送株式会社と連携し新卒採用のリモート化を推奨</a></td>
                </tr>
            </table>

            <nav><a href="{{route('client.news.list')}}">ニュース一覧</a></nav>
        </div>
    </section> -->
        ...
        <div class="main__about__inner">
            <div>
                ...
                <div class="main__about__video" id="video-wrap">
                    <video controlsList="nodownload" id="video" controls="" loop="" preload="none" poster="{{asset('img/client/index/poster.jpg')}}">
                        <source src="{{asset('video/introduction-for-clients.mp4')}}">
    ...
    <section class="main__feature">
        ...
        <div class="main__feature__functions">
            <figure>
                <img src="{{asset('img/client/index/circle_feature01.png')}}" alt="特徴1">
                <figcaption>全国の学生を検索。<br>自己PR動画や履歴書を<br>見て情報収集。</figcaption>
            </figure>
            <figure>
                <img src="{{asset('img/client/index/circle_feature02.png')}}" alt="特徴2">
                <figcaption>メッセージ機能で<br>気になる学生へコンタクト</figcaption>
            </figure>
            <figure>
                <img src="{{asset('img/client/index/circle_feature03.png')}}" alt="特徴3">
                <figcaption>自社PR動画の掲載。<br>御社に興味を持った学生から<br>メッセージがが届きます。</figcaption>
            </figure>
            <figure>
                <img src="{{asset('img/client/index/circle_feature04.png')}}" alt="特徴4">
                <figcaption>オンライン面接にて先行実施。<br>（インターン選考含む）</figcaption>
            </figure>
        </div>
        <img src="{{asset('img/client/index/arrow_feature.png')}}" alt="結果">
    ...
    <section class="main__example">
        ...
        <div>
            <h3>A社様</h3>
            <img src="{{asset('img/client/index/icon_example01.png')}}" alt="A社様">
            <p>学生検索から気になる学生へコンタクトし、後日オンライン面接実施。<br>メッセージにて二次面接通過のご連絡をし、最終面接は本社にて直接面談。</p>
        </div>
        <div>
            <h3>B社様</h3>
            <img src="{{asset('img/client/index/icon_example02.png')}}" alt="B社様">
            <p>B社様の企業動画や企業情報を閲覧した学生からメッセージが届く。<br>後日オンライン面接を実施し、メッセージにて内定通知のご連絡。</p>
        </div>
        <div>
            <h3>C社様</h3>
            <img src="{{asset('img/client/index/icon_example03.png')}}" alt="C社様">
    ...
    <section class="main__content__qa" id="qa">
        ...
        <dl>
            ...
            <dd class="main__ans"><div><p><a href="{{route('client.login')}}" class="link">ログインページ</a>から貴社のログインIDとログインパスワードをご入力のうえログインし、</p><p>《企業編集》より企業情報ほか動画や写真などをアップロードして企業ぺージを完成させてください。</p><p><a href="{{route('client.student.list')}}" class="link">《学生検索》</a>から求職者のWeb履歴書を閲覧いただき、《メッセージを送る》ボタンから求職者にメッセージを送ることができます。</p><p>Web面接を実施する場合は、求職者とのメッセージから面接日時を決定し、</p><p>《Web面接を予約する》ボタンからWeb面接の予約を行ってください。</p><p>面接日時になりましたら、<a href="{{route('client.video-interview.list')}}">Web面接学生一覧</a>よりWeb面接を実施する学生を選択し、ご利用可能ブラウザのチェックボックスにチェックを入れ、Web面接ルームに入室後、《接続》ボタンをタップして面接を開始してください。</p><div></dd>
            <dt class="main__qa">利用料金について知りたいのですが。</dt>
            <dd class="main__ans"><p>ご利用料金につきましては企業様の用途に基づいた複数のプランをご用意しておりますので、<a href="{{route('client.contact')}}" class="link">お問い合わせフォーム</a>からお問い合わせいただければ担当者よりご連絡させていただきます。</p></dd>
        ...
        <dl class="qa__list">
                ...
                <dd class="main__qa--more-ans"><div class="ans__box"><div><p>アップロード可能な動画容量は1GBとなっております。</p><p>1GB以下に圧縮してアップロードを行ってください。</p><p>解決できない場合は、<a href="{{route('client.contact')}}" class="link">お問い合わせフォーム</a>よりお問い合わせください。</p></div></div></dd>
                <dt class="main__qa--more-qa">動画を用意していないのですが。</dt>
                <dd class="main__qa--more-ans"><div class="ans__box"><div><p>LinkTは動画制作サービス(別途料金)も行っております。</p><p>制作をご希望の企業様は<a href="{{route('client.contact')}}" class="link">お問い合わせフォーム</a>よりご連絡ください。</p></div></div></dd>
                ...
                <dd class="main__qa--more-ans"><div class="ans__box"><p><a href="{{route('client.message.list')}}" class="link">《メッセージ》</a>から通知する学生に結果のご連絡を行ってください。</p></div></dd>
            </dl>
        </dl>
    </section>
    @else
    <section class="main__content__qa" id="qa">
        ...
        <dl>
            <dt class="main__qa">基本的な利用の仕方について教えてください。</dt>
            <dd class="main__ans"><div><p><a href="{{route('client.login')}}" class="link">ログインページ</a>から貴社のログインIDとログインパスワードをご入力のうえログインし、</p><p>《企業編集》より企業情報ほか動画や写真などをアップロードして企業ぺージを完成させてください。</p><p><a href="{{route('client.student.list')}}" class="link">《学生検索》</a>から求職者のWeb履歴書を閲覧いただき、</p><p>《メッセージを送る》ボタンから求職者にメッセージを送ることができます。</p><p>Web面接を実施する場合は、求職者とのメッセージから面接日時を決定し、</p><p>《Web面接を予約する》ボタンからWeb面接の予約を行ってください。</p><p>面接日時になりましたら、<a href="{{route('client.video-interview.list')}}">Web面接学生一覧</a>よりWeb面接を実施する学生を選択し、ご利用可能ブラウザのチェックボックスにチェックを入れ、Web面接ルームに入室後、《接続》ボタンをタップして面接を開始してください。</p><div></dd>
            <dt class="main__qa">求職者からのメッセージ返信率をあげるにはどうすればよいでしょうか。</dt>
            <dd class="main__ans"><div><p>自社ページの完成度が高い企業様のメッセージ返信率が高い傾向にあります。</p><p>特に、学生に自社の強みを伝えるには動画によるPRが効果的です。</p><p>ログイン後、《企業編集》より企業情報のほか動画や写真などをアップロードし企業ページを完成させてください。</p></div></dd>
            <dt class="main__qa">動画がアップロードできません。</dt>
            <dd class="main__ans"><div><p>アップロード可能な動画容量は1GBとなっております。</p><p>1GB以下に圧縮してアップロードを行ってください。</p><p>解決できない場合は、<a href="{{route('client.contact')}}" class="link">お問い合わせフォーム</a>よりお問い合わせください。</p></div></dd>
        </dl>
        <h2 class="headline main__qa--more" id="qa__list--open">質問をもっと見る</h2>
        <dl class="qa__list">
                <dt class="main__qa--more-qa">動画を用意していないのですが。</dt>
