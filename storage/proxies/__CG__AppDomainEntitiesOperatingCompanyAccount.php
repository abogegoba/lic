 ...
 */
class OperatingCompanyAccount extends \App\Domain\Entities\OperatingCompanyAccount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'lastName', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'firstName', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'lastNameKana', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'firstNameKana', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'userAccount', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'createdAt', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'createdBy', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'updatedAt', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'updatedBy', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'deletedAt', '' . "\0" . 'App\\Domain\\Entities\\OperatingCompanyAccount' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OperatingCompanyAccount $proxy) {
