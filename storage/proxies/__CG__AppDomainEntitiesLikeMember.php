 ...
 */
class LikeMember extends \App\Domain\Entities\LikeMember implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'company', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'member', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'status', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'createdAt', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'createdBy', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'updatedAt', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'updatedBy', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'deletedAt', '' . "\0" . 'App\\Domain\\Entities\\LikeMember' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LikeMember $proxy) {
