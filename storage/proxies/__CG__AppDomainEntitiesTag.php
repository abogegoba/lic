 ...
 */
class Tag extends \App\Domain\Entities\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'name', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'color', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'fixingFlag', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'member', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'company', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'createdAt', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'createdBy', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'updatedAt', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'updatedBy', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'deletedAt', '' . "\0" . 'App\\Domain\\Entities\\Tag' . "\0" . 'id'];
        }
     ...
     * {@inheritDoc}
     */
    public function getFixingFlag(): ?int
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFixingFlag', []);

        return parent::getFixingFlag();
    }

    /**
     * {@inheritDoc}
     */
    public function setFixingFlag(?int $fixingFlag): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFixingFlag', [$fixingFlag]);

        parent::setFixingFlag($fixingFlag);
    }
