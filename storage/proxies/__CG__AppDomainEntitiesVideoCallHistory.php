 ...
 */
class VideoCallHistory extends \App\Domain\Entities\VideoCallHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'companyUserAccount', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'memberUserAccount', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'startDatetime', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'callMinutes', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'createdAt', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'createdBy', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'updatedAt', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'updatedBy', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'deletedAt', '' . "\0" . 'App\\Domain\\Entities\\VideoCallHistory' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VideoCallHistory $proxy) {
    ...
    public function getCallMinutes(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCallMinutes', []);

        return parent::getCallMinutes();
    }
    ...
    public function setCallMinutes(?int $callMinutes): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCallMinutes', [$callMinutes]);

        parent::setCallMinutes($callMinutes);
    }
