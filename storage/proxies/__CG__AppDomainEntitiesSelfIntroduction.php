 ...
 */
class SelfIntroduction extends \App\Domain\Entities\SelfIntroduction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'member', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'title', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'content', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'displayNumber', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'createdAt', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'createdBy', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'updatedAt', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'updatedBy', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'deletedAt', '' . "\0" . 'App\\Domain\\Entities\\SelfIntroduction' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SelfIntroduction $proxy) {
