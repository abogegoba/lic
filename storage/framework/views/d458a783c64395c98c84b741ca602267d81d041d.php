<?php $__env->startSection('description','ニュース一覧：ニュース一覧表示'); ?>

<?php $__env->startSection('title','ニュース　｜　次世代型就活サイト　LinkT'); ?>

<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/news/index.css')); ?>">
    <style>
        .b_background{
            background: #000;
    ...
    <div class="main__content content__news content__term">
        ...
        <div class="news__list">
            ...
            <div class="news__item" data-list="tag01">
                <a href="<?php echo e(route('client.news.detail_4')); ?>" rel="noopener">
                    <div class="news__item__img img--logo">
                        <img src="<?php echo e(asset('img/partner/logo/20200303-02_thumb.jpg')); ?>" alt="LinkT(リンクト)、新型コロナウイルス感染拡大による新卒採用イベント中止に伴い採用動画無料制作キャンペーン実施">
                    </div>
            ...
            <div class="news__item" data-list="tag01">
                <a href="<?php echo e(route('client.news.detail_5')); ?>" rel="noopener">
                    <div class="news__item__img img--logo">
                        <img src="<?php echo e(asset('img/partner/logo/20200303-01_thumb.png')); ?>" alt="LinkT(リンクト)、ローカル放送局の長崎放送株式会社と連携し新卒採用のリモート化を推奨">
                    </div>
                    <div class="news__item__title">
            ...
            <div class="news__item" data-list="tag01">
                <a href="<?php echo e(route('client.news.detail_6')); ?>" rel="noopener">
                    <div class="news__item__img img--logo">
                        <img src="<?php echo e(asset('img/partner/logo/20200303-00_thumb.jpg')); ?>" alt="LinkT、台湾人大学生の登録を開始">
                    </div>
                    <div class="news__item__title">
                        LinkT、台湾人大学生の登録を開始
                    </div>
            ...
            <div class="news__item" data-list="tag02">
                <a href="<?php echo e(route('client.lp.touei-housing-corporation')); ?>" target="_blank" rel="noopener">
                    <div class="news__item__img img--logo">
                        <img src="<?php echo e(asset('img/partner/logo/touei-housing-corporation01.png')); ?>" alt="東栄住宅×LinkT FUKUOKA STREET PARTY でコラボブース出展">
                    </div>
                    <div class="news__item__title">
            ...
            <div class="news__item" data-list="tag01">
                <a href="<?php echo e(route('client.news.detail_3')); ?>">
                    <div class="news__item__img img--logo">
                        <img src="<?php echo e(asset('img/partner/logo/mbg-trade-media-japan01.png')); ?>" alt="株式会社トレードメディアジャパンとパートナー契約を締結">
                    </div>
                    <div class="news__item__title">
            ...
            <div class="news__item" data-list="tag01">
                <a href="<?php echo e(route('client.news.detail_2')); ?>">
                    <div class="news__item__img img--logo">
                        <img src="<?php echo e(asset('img/partner/logo/nbc-nagasaki01.png')); ?>" alt="長崎放送株式会社とパートナー契約を締結">
                    </div>
                    <div class="news__item__title">
                        長崎放送株式会社とパートナー契約を締結
                    </div>
            ...
            <div class="news__item" data-list="tag01">
                <a href="<?php echo e(route('client.news.detail_1')); ?>">
                    <div class="news__item__img img--logo">
                        <img src="<?php echo e(asset('img/partner/logo/dentsu01.png')); ?>" alt="株式会社電通とパートナー契約を締結">
                    </div>
                    <div class="news__item__title">
                        株式会社電通とパートナー契約を締結
                    </div>
            ...
            <div class="news__item" data-list="tag01">
                ...
                <div class="news__item__img img--logo">
                    <img src="<?php echo e(asset('img/partner/logo/gogaku01.png')); ?>" alt="Gogaku株式会社とパートナー契約を締結">
                </div>
                <div class="news__item__title">
            ...
            <div class="news__item" data-list="tag03">
                <div class="news__item__img img--logo b_background">
                    <img src="<?php echo e(asset('img/client/media/1.png')); ?>" alt="テレビ山口【tys情報PickUp】 に取り上げられました。">
                </div>
                <div class="news__item__title">
            ...
            <div class="news__item" data-list="tag03">
                <div class="news__item__img img--logo">
                    <img src="<?php echo e(asset('img/client/media/2_2x.png')); ?>" alt="大分放送【アレ・コレBOX】 に取り上げられました。">
                </div>
                <div class="news__item__title">
            ...
            <div class="news__item" data-list="tag03">
                <div class="news__item__img img--logo">
                    <img src="<?php echo e(asset('img/client/media/3.jpg')); ?>" alt="中国放送【ランキンLand！】 に取り上げられました。">
                </div>
                <div class="news__item__title">
            ...
            <div class="news__item" data-list="tag03">
                <div class="news__item__img img--logo">
                    <img src="<?php echo e(asset('img/client/media/4_2x.png')); ?>" alt="長崎放送【あっぷる】 に取り上げられました。">
                </div>
                <div class="news__item__title">
            ...
            <div class="news__item" data-list="tag03">
                <div class="news__item__img img--logo">
                    <img src="<?php echo e(asset('img/client/media/5_2x.png')); ?>" alt="長野朝日放送【今ドキ！昼ドキッ】 に取り上げられました。">
                </div>
                <div class="news__item__title">
