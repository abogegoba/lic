...
<?php $__env->startSection('title','infit、サービスの海外展開に向けて株式会社トレードメディアジャパン（ＭＲＴ宮崎放送グループ）とパートナー契約を締結　｜　次世代型就活サイト　LinkT'); ?>
        ...
        <div class="news__detail__content">
            <p>
                ...
                <span class="news__logo__inline">
                            <img src="<?php echo e(asset('img/partner/logo/mbg-trade-media-japan01.png')); ?>" alt="株式会社トレードメディアジャパン" class="news__logo">
                            <img src="<?php echo e(asset('img/news/linkt.png')); ?>" alt="次世代型就活サイト：LinkT" class="news__logo">
                        </span>
            </p>
            <p>
