<?php $__env->startSection('description','新卒、第二新卒向けの就活・インターンサイト【LinkT（リンクト）】の学生向けサービス説明ページです。学生の就職活動における悩みをLinkTを使えばどのように解決できるのか、また、利用の流れや、よくある質問とその回答について記載しています。'); ?>

<?php $__env->startSection('title','LinkT（リンクト）とは ｜次世代の就活ならLinkT(リンクト)'); ?>
    ...
    <section class="main__catch requid">
        ...
        <div class="navBk">
            <?php if(!isset($memberAuthentication)): ?>
                <a href="<?php echo e(route("front.static.select_entry")); ?>">会員登録</a>
            <?php endif; ?>
            <a href="<?php echo e(route('front.static.describe')); ?>">使い方はこちら</a>
        </div>
        <p>LinkTは就活性が抱える悩みを解決し、<br>就活を成功へ導きます。</p>
    </section>
    <section class="main__summary fullWidth">
        <picture>
            <source media="(max-width: 767px)" srcset=<?php echo e(asset("img/about/img_trouble-sp.jpg")); ?>>
            <img src="<?php echo e(asset("img/about/img_trouble-pc.jpg")); ?>" alt="LinkTで解決">
        </picture>
    ...
    <section class="main__content">
        ...
        <section class="main__content__qa" id="qa">
            ...
            <dl>
                ...
                <dd class="main__ans"><p><a href="<?php echo e(route("front.contact")); ?>" class="link">お問い合わせフォーム</a>よりLinkT運営事務局にお問い合わせください。<br>※ログインIDは会員登録時に使用したメールアドレスになります。</p></dd>
                <dt class="main__qa">ログインパスワードを忘れた場合は？</dt>
                <dd class="main__ans"><p><a href="<?php echo e(route("front.contact")); ?>" class="link">お問い合わせフォーム</a>よりLinkT運営事務局にお問い合わせください。</p></dd>
                <dt class="main__qa">ログインができないのですが？</dt>
                <dd class="main__ans"><div><p>本登録はお済みですか？</p><p><a href="<?php echo e(route("front.static.select_entry")); ?>" class="link">会員登録ページ</a>から仮会員登録を完了させると登録したメールアドレス宛に本登録手続きのメールが届きますので、メール本文中のURLをタップして本登録を完了すればご利用が可能になります。<br>再度、<a href="<?php echo e(route("front.member.login")); ?>" class="link">ログインページ</a>でログインIDとパスワードを入力し、ログインしてください。<br>※本登録が完了していない場合はログインIDとパスワードを入力してもログインができないのでご注意ください。</p></div></dd>
            </dl>
            <h2 class="headline main__qa--more" id="qa__list--open">質問をもっと見る</h2>
            <dl class="qa__list">
                    <dt class="main__qa--more-qa">会員登録の仕方について教えてください。</dt>
                    <dd class="main__qa--more-ans"><div class="ans__box"><div><p><a href="<?php echo e(route("front.static.select_entry")); ?>" class="link">会員登録ページ</a>から仮会員登録を完了させてください。</p><p>登録したメールアドレス宛に本登録手続きのメールが届きますので、メール本文中のURLをタップして本登録を完了すればご利用が可能になります。</p><p><a href="<?php echo e(route("front.member.login")); ?>" class="link">ログインページ</a>からログインしてご利用を開始してください。<br>※本登録が完了していない場合はログインIDとパスワードを入力してもログインができないのでご注意ください。</p></div></div></dd>
                    <dt class="main__qa--more-qa">LinkTの基本的な使い方について教えてください。</dt>
                    <dd class="main__qa--more-ans"><div class="ans__box"><div><p>まずは、<a href="<?php echo e(route("front.static.select_entry")); ?>" class="link">会員登録ページ</a>から仮会員登録を完了させてください。</p><p>登録したメールアドレス宛に本登録手続きのメールが届きますのでメール本文中のURLをタップして本登録を完了すればご利用が可能になります。</p><p><a href="<?php echo e(route("front.member.login")); ?>" class="link">ログインページ</a>からログインし、</p><p>《プロフィール編集》よりあなたの履歴書を完成させてください。</p><p>《企業検索》からご希望の条件を絞って企業を検索し、企業ページ中の</p><p>《面接依頼または質問をする》ボタンをタップして採用担当者と直接メッセージのやり取りを行うことができます。<p></p>Web面接を行う場合は、企業より送られるWeb面接予約をタップしてWeb面接ルームに入室をし、《接続する》ボタンをタップし面接を開始してください。</p><p>※Web面接ルーム入室前に、利用可能なブラウザのチェックボックスにチェックを入れてください面接結果はメッセージ画面に届きます。その後は企業の指示に従ってください。</p></div></div></dd>
                    ...
                    <dd class="main__qa--more-ans"><div class="ans__box"><div><p>ログイン後メニュー中の《Web面接》から、<a href="<?php echo e(route("front.video-interview.list")); ?>" class="link">面接予約一覧</a>より予約内容を確認してください。</p><p>面接日時になりましたら、利用可能なブラウザのチェックボックスにチェックを入れ、</p><p>《Web面接ルームへ》をタップして入室し、面接時間になったら</p><p>《接続する》をタップして面接を開始してください。</p></div></div></dd>
                    ...
                    <dd class="main__qa--more-ans"><div class="ans__box"><p>ログイン後、メニュー中の《Web面接》から、<a href="<?php echo e(route("front.video-interview.list")); ?>" class="link">面接予約一覧</a>をタップし、キャンセルを行ってください。</p></div></dd>
                    ...
                    <dd class="main__qa--more-ans"><div class="ans__box"><p><a href="<?php echo e(route("front.static.describe")); ?>" class="link">LinkTの使い方</a>をご覧ください。</p></div></dd>
        ...
        <section class="main__content__qa" id="qa">
            ...
            <dl>
                ...
                <dd class="main__ans"><div><p>まずは、<a href="<?php echo e(route("front.static.select_entry")); ?>" class="link">会員登録ページ</a>から仮会員登録を完了させてください。</p><p>登録したメールアドレス宛に本登録手続きのメールが届きますのでメール本文中のURLをタップして本登録を完了すればご利用が可能になります。</p><p><a href="<?php echo e(route("front.member.login")); ?>" class="link">ログインページ</a>からログインし、</p><p>《プロフィール編集》よりあなたの履歴書を完成させてください。</p><p>《企業検索》からご希望の条件を絞って企業を検索し、企業ページ中の</p><p>《面接依頼または質問をする》ボタンをタップして採用担当者と直接メッセージのやり取りを行うことができます。<p></p>Web面接を行う場合は、企業より送られるWeb面接予約をタップしてWeb面接ルームに入室をし、《接続する》ボタンをタップし面接を開始してください。</p><p>※Web面接ルーム入室前に、利用可能なブラウザのチェックボックスにチェックを入れてください面接結果はメッセージ画面に届きます。その後は企業の指示に従ってください。</p></div></dd>
                ...
                <dd class="main__ans"><div><p>メニュー中の《Web面接》から、<a href="<?php echo e(route("front.video-interview.list")); ?>" class="link">面接予約一覧</a>より予約内容を確認してください。</p><p>面接日時になりましたら、利用可能なブラウザのチェックボックスにチェックを入れ、</p><p>《Web面接ルームへ》をタップして入室し、面接時間になったら</p><p>《接続する》をタップして面接を開始してください。</p></div></dd>
            </dl>
            <h2 class="headline main__qa--more" id="qa__list--open">質問をもっと見る</h2>
            <dl class="qa__list">
                <dt class="main__qa--more-qa">面接結果はどのようにして通知されますか？</dt>
        ...
        <div class="navBk">
            <?php if(!isset($memberAuthentication)): ?>
                <a href="<?php echo e(route("front.static.select_entry")); ?>">会員登録</a>
            <?php endif; ?>
            <a href="<?php echo e(route('front.static.describe')); ?>">使い方はこちら</a></div>
    </section>
<?php $__env->stopSection(); ?>
