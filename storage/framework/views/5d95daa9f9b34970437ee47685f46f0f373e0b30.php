...
<?php $__env->startSection('content'); ?>
    ...
    <div id="main__content">
        <?php echo e(Form::open(['url'=>route('front.member-entry.four-next')])); ?>
        ...
        <div class="form__controls">
            <input type="button" value="戻る" class="form__controls__prev js-btn-link" data-href="<?php echo e(route('front.member-entry.revise-three')); ?>">
