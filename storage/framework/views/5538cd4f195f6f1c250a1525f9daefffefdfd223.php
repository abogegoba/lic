<?php $__env->startSection('description','新卒、第二新卒向けの就活・インターンサイト【LinkT（リンクト）】に掲載されている企業をお好みの条件で絞り込みできる検索詳細ページです。「フリーワード」「業種」「職種」「地域」で絞り込みができるので探している企業を簡単に見つけられます。'); ?>

<?php $__env->startSection('title','企業検索詳細｜LinkT(リンクト) - 新卒・第二新卒向けの次世代型就活サイト'); ?>

<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/company-search/common.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/company-search/index.css')); ?>">
...
<?php $__env->startSection('script'); ?>
    <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo e($data->get('trackingId')); ?>"></script>
    <script>
...
<?php $__env->startSection('js'); ?>
    <script src="<?php echo e(asset('js/company-search-detail/scroll.js')); ?>"></script>
    <script src="<?php echo e(asset('js/company-search-detail/list.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <input type="hidden" name="tracking-id" value="<?php echo e($data->get('trackingId')); ?>" id='trackingId'>
    ...
    <section class="main__content">
        ...
        <async-search v-cloak id="company-search" url="<?php echo e(route("front.company.search")); ?>" :initial-search="true" <?php if($data->has("pager.index")): ?> :initial-page-index="<?php echo e($data->get("pager.index")); ?>" :is-pager="true" <?php endif; ?>>
                ...
                <div class="fnd-company">
                    ...
                    <div class="find-company__selects invalid-form">
                        <div class="selectBox__wrapper">
                            <?php echo e(Form::select('industryCondition', $data->get('businessTypeList'), $data->get("industryCondition"), ["v-bind:class" => "component.errors.industryCondition ? 'invalid-control' : ''", "id"=>"industryCondition","placeholder" => "業種"])); ?>

                        </div>
                        <div class="selectBox__wrapper">
                            <?php echo e(Form::select('jobTypeCondition', $data->get('jobTypeList'), $data->get("jobTypeCondition"), ["v-bind:class" => "component.errors.jobTypeCondition ? 'invalid-control' : ''", "id"=>"jobTypeCondition","placeholder" => "職種"])); ?>

                        </div>
                        <div class="selectBox__wrapper">
                            <?php echo e(Form::select('areaCondition', $data->get('prefectureList'), $data->get("areaCondition"), ["v-bind:class" => "component.errors.areaCondition ? 'invalid-control' : ''", "id"=>"areaCondition","placeholder" => "エリア"])); ?>

                        </div>
                    </div>
                    <div class="fnd-company__search invalid-form">
                        <?php echo e(Form::search('companyNameCondition', $data->get("companyNameCondition"), ["v-bind:class" => "component.errors.companyNameCondition ? 'invalid-control' : ''", "id"=>"companyNameCondition","placeholder"=>"企業名で検索しよう", "maxlength" =>255])); ?>

                        
                    </div>
                    <div class="find-company__search__checklists">
                        
                        <?php echo e(Form::checkbox('recruitmentTargetConditionThisYear', 1, $data->get("recruitmentTargetConditionThisYear"), ["v-bind:checked" => "component.recruitmentTargetConditionThisYear","id"=>"recruitmentTargetConditionThisYear"])); ?>
                        ...
                        <?php echo e(Form::checkbox('recruitmentTargetConditionNextYear', 1, $data->get("recruitmentTargetConditionNextYear"), ["v-bind:checked" => "component.recruitmentTargetConditionNextYear","id"=>"recruitmentTargetConditionNextYear"])); ?>
                        ...
                        <?php echo e(Form::checkbox('recruitmentTargetConditionIntern', 1, $data->get("recruitmentTargetConditionIntern"), ["v-bind:checked" => "component.recruitmentTargetConditionIntern", "id"=>"recruitmentTargetConditionIntern"])); ?>
            ...
            <?php echo $__env->make('front.common.vue_pagination', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </async-search>
    </section>
