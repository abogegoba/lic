    ...
    <section id="voice-list">
        ...
        <div class="inner">
            <div class="user_voice_chatbox">
                ...
                <div class="user_voice">
                    <img src="<?php echo e(asset('img/describe/vo_yk@2x.png')); ?>" alt="">
                    <div class="user_name_chat">
                ...
                <div class="user_voice">
                    <img src="<?php echo e(asset('img/describe/vo_ja@2x.png')); ?>" alt="">
                    <div class="user_name_chat">
                    ...
                    <div class="user_voice">
                        <img src="<?php echo e(asset('img/describe/vo_kh@2x.png')); ?>" alt="">
                        <div class="user_name_chat">
                            <p class="user_name">亜細亜大学 KHさん</p>
                            <div class="triangle-left"></div>
                            <div class="chat_msg">
                                <p>1社ずつ履歴書を作成する必要がない！</p>
                                <a href="<?php echo e(route('front.static.customer4')); ?>">詳しくはこちら</a>
                            </div>
                        </div>
                    </div>
                    <div class="user_voice">
                        <img src="<?php echo e(asset('img/describe/vo_st@2x.png')); ?>" alt="">
                        <div class="user_name_chat">
                            <p class="user_name">日本外国語専門学校 STさん</p>
                            <div class="triangle-left"></div>
                            <div class="chat_msg">
                                <p>1社ずつ履歴書を作成する必要がない！</p>
                                <a href="<?php echo e(route('front.static.customer5')); ?>">詳しくはこちら</a>
                            </div>
                        </div>
                    </div>
                </div>
