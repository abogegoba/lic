...
<?php $__env->startSection('content'); ?>
    ...
    <div id="main__content">
        <form class="form__confirm">
            ...
            <input type="submit" value="修正" class="form__button js-btn-link" data-href="<?php echo e(route('front.member-entry.revise-one')); ?>">
        </form>
        <form class="form__confirm">
            <dl>
                <dt>国籍</dt>
            ...
            <input type="submit" value="修正" class="form__button js-btn-link" data-href="<?php echo e(route('front.member-entry.revise-two')); ?>">
        </form>
        <form class="form__confirm">
            <dl>
                <dt>学校情報</dt>
                <dd><?php echo e($data->get('schoolType')); ?>／<?php echo e($data->get('facultyType')); ?><br><?php echo e($data->get('name')); ?><br><?php echo e($data->get('departmentName')); ?><br><?php echo e($data->get('graduationPeriodYear')); ?>

                    年<?php echo e($data->get('graduationPeriodMonth')); ?>月<?php echo e($data->get('graduationPeriodTypeLabel')); ?></dd>
            </dl>
            <input type="submit" value="修正" class="form__button js-btn-link" data-href="<?php echo e(route('front.member-entry.revise-three')); ?>">
        ...
        <form class="form__confirm">
            ...
            <input type="submit" value="修正" class="form__button js-btn-link" data-href="<?php echo e(route('front.member-entry.revise-four')); ?>">
        </form>
        <form class="form__confirm">
            <dl>
                <dt>ID・パスワード</dt>
            ...
            <input type="submit" value="修正" class="form__button js-btn-link" data-href="<?php echo e(route('front.member-entry.revise-five')); ?>">
        ...
        <?php echo e(Form::open(['url'=>route('front.member-entry.store')])); ?>
        ...
        <div class="terms invalid-form">
            ...
            <div class="temrs__consent">
                <?php echo e(Form::checkbox('agreement', 1, '', ["id"=>"agreement"])); ?><label for="agreement">ご利用規約および取り扱いについて同意する</label>
            </div>
        ...
        <div class="form__controls">
            <input type="button" value="戻る" class="form__controls__prev js-btn-link" data-href="<?php echo e(route('front.member-entry.revise-five')); ?>">
