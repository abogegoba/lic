...
<?php $__env->startSection('title','長崎放送株式会社とパートナー契約を締結　｜　次世代型就活サイト　LinkT'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="main__content content__news__detail">
        ...
        <div class="news__detail__content">
            ...
            <p>
                ＜長崎放送株式会社　会社概要＞
                <img src="<?php echo e(asset('img/partner/logo/nbc-nagasaki01.png')); ?>" alt="長崎放送株式会社" class="news__logo">
                会社名：長崎放送株式会社<br>
                設立：1952年9月12日<br>
