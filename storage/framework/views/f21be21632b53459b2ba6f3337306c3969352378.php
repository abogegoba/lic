...
<link rel="stylesheet" href="<?php echo e(asset('css/mypage/cropper.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/bootstrap_custom.min.css')); ?>">
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
<script src="https://code.jquery.com/jquery-3.4.1.slim.min.js" crossorigin="anonymous"></script>
<script src="<?php echo e(asset('js/mypage/cropper.min.js')); ?>"></script>
<script>
        ...
        fetch(dataurl)
            ...
            .then(blob => {
                ...
                $.ajax({
                    ...
                    url: '<?php echo route('front.profile.photo.edit.upload-photo'); ?>',
                    data: fd,
                    processData: false,
                    contentType: false,
                    cache: false,
