...
<?php $__env->startSection('content'); ?>
    ...
    <div id="main__content">
        <?php echo e(Form::open(['url'=>route('front.overseas-member-entry.three-next')])); ?>
        ...
        <table class="form__table">
            ...
            <tr class="invalid-form">
                ...
                <td>
                    <?php echo e(Form::text('name', $data->get("name"), ["class" => (!empty($errors->has('name')) ? "invalid-control width100" : "width100"), "id"=>"name", "placeholder" => "例）Tokyo University", "maxlength" =>72])); ?>
            ...
            <tr class="invalid-form">
                <th class="required"><label for="facultyType">学部名</label></th>
                <td>
                    <div class="selectBox__wrapper width100">
                    <?php echo e(Form::select('facultyType', $data->get("overseasFacultyTypeList"), $data->get("facultyType"), ["class" => (!empty($errors->has('facultyType')) ? "invalid-control width100" : "width100"), "id"=>"facultyType", "placeholder" => "選択して下さい",])); ?>
        ...
        <div class="form__controls">
            <input type="button" value="戻る" class="form__controls__prev js-btn-link" data-href="<?php echo e(route('front.overseas-member-entry.revise-two')); ?>">
