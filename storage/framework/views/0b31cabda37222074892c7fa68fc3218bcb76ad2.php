...
<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('client/css/company-edit/detail-preview/common.css')); ?>">
    
    <link rel="stylesheet" href="<?php echo e(asset('client/css/company-edit/detail-preview/index_new.css')); ?>">
    
    <link rel="stylesheet" href="<?php echo e(asset('client/js/slick/slick_custom.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('client/js/slick/slick-theme.css')); ?>">
    <style>
        .mb-15{
            margin-bottom: 15px;
        }
...
<?php $__env->startSection('js'); ?>
    <script src="<?php echo e(asset('client/js/company/preview.js')); ?>"></script>
    <script src="<?php echo e(asset('client/js/BigPicture.js')); ?>"></script>
    ...
    <section class="contents">
                    ...
                    <?php else: ?>
                        <div class="video_tags">
                            <?php if(($data->get("shortLengthVideos.five")) !== null): ?>
                                <p class="htmlvid"><a vidSrc="<?php echo e($data->get("shortLengthVideos.five")); ?>" class="tag cursor-pointer"><img src="<?php echo e(asset('img/common/play-circle-regular.png')); ?>" alt=""><img src="<?php echo e(asset('img/common/5sec.png')); ?>" alt=""><span><?php echo e($data->get("shortLength5sVideoTitle")); ?></span></a></p>
                            <?php endif; ?>

                            <?php if(($data->get("shortLengthVideos.ten")) !== null): ?>
                                <p class="htmlvid"><a vidSrc="<?php echo e($data->get("shortLengthVideos.ten")); ?>" class="tag cursor-pointer"><img src="<?php echo e(asset('img/common/play-circle-regular.png')); ?>" alt=""><img src="<?php echo e(asset('img/common/10sec.png')); ?>" alt=""><span><?php echo e($data->get("shortLength10sVideoTitle")); ?></span></a></p>
                            <?php endif; ?>

                            <?php if(($data->get("shortLengthVideos.fifteen")) !== null): ?>
                                <p class="htmlvid"><a vidSrc="<?php echo e($data->get("shortLengthVideos.fifteen")); ?>" class="tag cursor-pointer"><img src="<?php echo e(asset('img/common/play-circle-regular.png')); ?>" alt=""><img src="<?php echo e(asset('img/common/15sec.png')); ?>" alt=""><span><?php echo e($data->get("shortLength15sVideoTitle")); ?></span></a></p>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="all_width">
                                    ...
                                    <?php $__currentLoopData = $data->get('jobApplications'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $jobApplication): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="<?php echo e($key === 0 ? 'active':''); ?>">
                                            <a href="#<?php echo e($jobApplication->get('id')); ?>">
                                                <?php echo e(mb_strlen($jobApplication->get("recruitmentJobType")->get('name')) > 5 ? mb_substr($jobApplication->get("recruitmentJobType")->get('name'), 0, 5).'...' : $jobApplication->get("recruitmentJobType")->get('name')); ?>
                            ...
                            <?php $__currentLoopData = $data->get('jobApplications'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $jobApplication): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div id="<?php echo e($jobApplication->get('id')); ?>" class="job_application_with_switch_tab">
                                    <h2><?php echo e($jobApplication->get("RecruitmentJobType")->get('name')); ?></h2>
        ...
        <div class="reload web_view" id="return_button">
            ...
            <form action="#" class="ftr-form">
                <input type="button" class="anchor--back cursor-pointer js-btn-link js-key-save" value="戻る" data-href="">
            </form>
        </div>
...
<?php echo $__env->make('admin.job_application.parts.client_root', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>