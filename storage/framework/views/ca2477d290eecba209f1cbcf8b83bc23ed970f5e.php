...
<?php echo e($data->get('companyAccount.company.name')); ?><br>

<?php echo e($data->get('companyAccount.lastName')); ?> <?php echo e($data->get('companyAccount.firstName')); ?>様<br>
<br>
...
面接者：<?php echo e($data->get('member.lastName')); ?> <?php echo e($data->get('member.firstName')); ?><br>

面接日時：<?php echo e($data->get('appointmentDatetime')); ?><br>
<br>
キャンセルメッセージ：<br>
<?php echo e($data->get('cancelMessage')); ?><br>
<br>
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+<br>
■ご注意事項<br>
<br>
