<?php $__env->startSection('title','会員変更'); ?>
...
<?php $__env->startSection('content'); ?>
    <h1 class="content-title" id="upload-content" data-upload-url="<?php echo e(route('admin.upload')); ?>">会員変更</h1>
    ...
    <?php endif; ?>
    <?php if($data->get("country") == 1): ?>
    <?php echo e(Form::open(['url'=>route('admin.member.edit',["memberId"=>$data->get("memberId")])])); ?>

    <?php else: ?>
    <?php echo e(Form::open(['url'=>route('admin.member.overseas_edit',["memberId"=>$data->get("memberId")])])); ?>

    <?php endif; ?>

    <?php echo $__env->make('admin.member.parts.input_2', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
