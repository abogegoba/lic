<?php $__env->startSection('title','Web面接予約一覧│マイページ｜LinkT(リンクト)'); ?>
                                        ...
                                        <template v-if="day.thisMonth === currentMonth">
                                            <div class="plan-modal" :class="{'active' : (selectedCompanyId === appointment.id && isOpen) }">
                                                ...
                                                <div class="plan-modal__contents">
                                                    <p :data-href="appointment.companyDetailUrl" class="plan-modal__name js-link-area cursor-pointer"><img class="ico" src="<?php echo e(asset('img/mypage/video/user-regular.svg')); ?>">{{appointment.companyName}}</p>
