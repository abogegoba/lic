...
<?php $__env->startSection('content'); ?>
    <div class="main__content content__partner content__term">
        ...
        <div class="partner__content">
            ...
            <p>
                <a href="<?php echo e(route('front.news.detail_3')); ?>">infitと株式会社トレードメディアジャパンのパートナー契約締結のリリースはこちら</a>
            </p>
        </div>
        ...
        <div class="partner__content">
            ...
            <p>
                <a href="<?php echo e(route('front.news.detail_2')); ?>">infitと長崎放送のパートナー契約締結のリリースはこちら</a>
            </p>
        </div>
        ...
        <div class="partner__content">
            ...
            <p>
                <a href="<?php echo e(route('front.news.detail_1')); ?>">infitと電通のパートナー契約締結のリリースはこちら</a>
            </p>
        </div>
