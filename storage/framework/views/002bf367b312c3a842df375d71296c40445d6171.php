<?php $__env->startSection('title','学生検索詳細｜LinkT(リンクト) - 次世代型新卒・第二新卒採用サービス'); ?>
...
<?php $__env->startSection('vue'); ?>
    <script src="<?php echo e(asset('js/student/list_vue.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="main__content">
        ...
        <div id="japan" class="tabcontent">
            <?php if($data->get("reloadFlg") === false): ?>
            <async-search v-cloak id="student-search" class="japan_student_search" url="<?php echo e(route("client.student.search")); ?>" :initial-search="false" <?php if($data->get("pager.index")): ?> :initial-page-index="<?php echo e($data->get("pager.index")); ?>" :is-pager="true" <?php endif; ?>>
            <?php elseif($data->get("reloadFlg") === true): ?>
            <async-search v-cloak id="student-search" class="japan_student_search" url="<?php echo e(route("client.student.search")); ?>" :initial-search="true" <?php if($data->get("pager.index")): ?> :initial-page-index="<?php echo e($data->get("pager.index")); ?>" :is-pager="true" <?php endif; ?>>
            <?php endif; ?>
                <div slot="condition-field" slot-scope="component" class="fnd-company student">
                    ...
                    <div class="fnd-company__search invalid-form">
                        <?php echo e(Form::search('keywordCondition', $data->get("keywordCondition"), ["v-bind:class" => "component.errors.keywordCondition ? 'invalid-control' : ''", "id"=>"keywordCondition","placeholder"=>"学生名、学校名で検索してください", "maxlength" =>255])); ?>
                    ...
                    <div class="find-company__selects invalid-form">
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                ...
                                <?php echo e(Form::select('undergraduateCourseCondition', $data->get("facultyTypeList"), $data->get("undergraduateCourseCondition"), ["v-bind:class" => "component.errors.undergraduateCourseCondition ? 'invalid-control' : ''", "id"=>"undergraduateCourseCondition","placeholder" => "学部系統"])); ?>
                        ...
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                <?php echo e(Form::select('industryCondition', $data->get("businessTypeList"), $data->get("industryCondition"), ["v-bind:class" => "component.errors.industryCondition ? 'invalid-control' : ''", "id"=>"industryCondition","placeholder" => "希望業種"])); ?>
                        ...
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                <?php echo e(Form::select('areaCondition', $data->get("prefectureList"), $data->get("areaCondition"), ["v-bind:class" => "component.errors.areaCondition ? 'invalid-control' : ''", "id"=>"areaCondition","placeholder" => "希望勤務地"])); ?>
                    ...
                    <div class="find-company__selects invalid-form">
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                <?php echo e(Form::select('graduationPeriodYear', $data->get("yearList"), $data->get("graduationPeriodYear"), ["v-bind:class" => "component.errors.graduationPeriodYear ? 'invalid-control' : ''", "id"=>"graduationPeriodYear","placeholder" => "卒業年"])); ?>
                        ...
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                <?php echo e(Form::select('graduationPeriodMonth', $data->get("monthList"), $data->get("graduationPeriodMonth"), ["v-bind:class" => "component.errors.graduationPeriodMonth ? 'invalid-control' : ''", "id"=>"graduationPeriodMonth","placeholder" => "卒業月"])); ?>
                    ...
                    <div class="find-company__checklists">
                        <?php echo e(Form::checkbox('isInternApplicantCondition', 1, '', ["v-bind:checked" => "component.isInternApplicantCondition", "id"=>"isInternApplicantCondition"])); ?>

                        <label for="isInternApplicantCondition">インターン希望者</label>

                        <?php echo e(Form::checkbox('isBelongsAthleticClubCondition', 1, '', ["v-bind:checked" => "component.isBelongsAthleticClubCondition", "id"=>"isBelongsAthleticClubCondition"])); ?>
                ...
                <div class="student_search" v-cloak slot="result-field" slot-scope="component" v-if="component.searched">
                                    ...
                                    <div class="student-like-parent">
                                        <div @click.stop="likeMember(index, component.result.students, component.result.loggedInCompanyAccountId)">
                                            <div v-if="student.checkLikeOrNotStatus == 20" class="student-like">
                                                <p>気になる</p>
                                                <img src="<?php echo e(asset('img/client/student-search/heart-small-regular.png')); ?>" alt="">
                                            </div>
                                            <div v-else class="student-not-like">
                                                <p>気になる</p>
                                                <img src="<?php echo e(asset('img/client/student-search/heart-small-gray.png')); ?>" alt="">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <?php echo $__env->make('client.common.vue_pagination_except_pages', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div id="overseas" class="tabcontent">
            <?php if($data->get("reloadFlg") === false): ?>
            <async-search v-cloak id="overseas-student-search" class="overseas_student_search" url="<?php echo e(route("client.overseas.student.search")); ?>" :initial-search="false" style="" <?php if($data->get("pager.index")): ?> :initial-page-index="<?php echo e($data->get("pager.index")); ?>" :is-pager="true" <?php endif; ?>>
            <?php elseif($data->get("reloadFlg") === true): ?>
            <async-search v-cloak id="overseas-student-search" class="overseas_student_search" url="<?php echo e(route("client.overseas.student.search")); ?>" :initial-search="true" <?php if($data->get("pager.index")): ?> :initial-page-index="<?php echo e($data->get("pager.index")); ?>" :is-pager="true" <?php endif; ?>>
            <?php endif; ?>
                <div slot="condition-field" slot-scope="component" class="fnd-company student">
                    <div class="error" v-if="component && component.errors && (component.errors.keywordCondition || component.errors.undergraduateCourseCondition || component.errors.isBelongsAthleticClubCondition || component.errors.isInternApplicantCondition)">
                        <div v-for="messages in component.errors">
                    ...
                    <div class="find-company__selects invalid-form">
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                ...
                                <?php echo e(Form::select('countryCondition', $data->get("overseasList"), $data->get("countryCondition"), ["v-bind:class" => "component.errors.countryCondition ? 'invalid-control' : ''", "id"=>"countryCondition","placeholder" => "国籍"])); ?>
                    ...
                    <div class="find-company__selects invalid-form">
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                ...
                                <?php echo e(Form::select('undergraduateCourseCondition', $data->get("overseasFacultyTypeList"), $data->get("undergraduateCourseCondition"), ["v-bind:class" => "component.errors.undergraduateCourseCondition ? 'invalid-control' : 'undergraduate_course_condition'", "id"=>"undergraduateCourseCondition","placeholder" => "学部"])); ?>
                        ...
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                <?php echo e(Form::select('industryCondition', $data->get("businessTypeList"), $data->get("industryCondition"), ["v-bind:class" => "component.errors.industryCondition ? 'invalid-control' : 'industry_condition'", "id"=>"industryCondition","placeholder" => "希望業種"])); ?>
                        ...
                        <div>
                            ...
                            <div class="selectBox__wrapper">
                                <?php echo e(Form::select('areaCondition', $data->get("prefectureList"), $data->get("areaCondition"), ["v-bind:class" => "component.errors.areaCondition ? 'invalid-control' : 'area_condition'", "id"=>"areaCondition","placeholder" => "希望勤務地"])); ?>
                    ...
                    <div class="find-company__checklists">
                        <?php echo e(Form::checkbox('isInternApplicantCondition', 1, '', ["v-bind:checked" => "component.isInternApplicantCondition", "id"=>"overseasIsInternApplicantCondition"])); ?>
