...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        .customer_info {
            background: url("<?php echo e(asset('img/describe/vo_yk22.png')); ?>") no-repeat;
        ...
        <div class="inner">
            ...
            <div class="customer_info">
                <div class="all">
                    ...
                    <!-- <a class="molink pco" href="<?php echo e(asset('video/describe/customer2.mp4')); ?>" data-lity>Y・Kさんの自己PR動画を見る ▶</a> -->
                </div>
            </div>

            <div class="customer_info_mobile">
                <img src="<?php echo e(asset('img/describe/vo_yk2.png')); ?>" alt="">
                <div class="all">
            ...
            <!-- <a class="molink spo" href="<?php echo e(asset('video/describe/customer2.mp4')); ?>" data-lity>M・Sさんの自己PR動画を見る ▶</a> -->
